...
It contains:  
- **Checklists**: Practical guides to secure development and common security pitfalls.  
- **Case Studies**: Public-friendly summaries of responsible disclosures.  
- **Screenshots**: Visuals for reference or demonstration purposes.  

## Current Work
- [Secure Development Checklist v1](checklists/secure_dev_checklist_v1.pdf)  
- [Sandbox Scholars Case Study](case-studies/sandbox-scholars.md)
